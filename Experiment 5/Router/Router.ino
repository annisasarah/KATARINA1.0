...
String server = "testtemphumid.000webhostapp.com"; // www.example.com
String uri = "/uploaddata.php";// our example is /esppost.

String ssid = "TJHINXL"; // ssid
String password = "tjhin1234"; // password
